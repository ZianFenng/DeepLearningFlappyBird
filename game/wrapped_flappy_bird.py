...
""" use pygame to have a game window """
FPS = 30
SCREENWIDTH = 288
SCREENHEIGHT = 512
pygame.init()
...
BASEY = SCREENHEIGHT * 0.79  # remain 107.5, base: 336(>288) * 112(>107.5)

PLAYER_WIDTH = IMAGES['player'][0].get_width()  # 34
PLAYER_HEIGHT = IMAGES['player'][0].get_height()  # 34
...
def getRandomPipePair():
    """returns a randomly generated pipe"""
    # y of the gap between upper and lower pipe
